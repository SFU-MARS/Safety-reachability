...
def create_params():
    ...
    # Set Matlab path
    p.MATLAB_PATH = '/local-scratch/tara/project/WayPtNav-reachability/reachability'
...
def create_reachability_data_dir_params(p):
    if p.thread == 'v1':
        ...
        # p.avoid_map_4d_name = 'TTR_grid_biggergrid_3lookback_wDisturbance_wObstalceMap_speedlimit3reverse_5.npy'
        # Configure map tmp
