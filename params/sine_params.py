...
def create_params():
    ...
    p.trainer = DotMap(
                        ...
                        ckpt_path='/local-scratch/anjianl/project/WayPtNav/data_tmp/sine_function_trainer_data/'
                                  'session_2019-06-11_11-26-53/checkpoints/ckpt-1'
    )
    ...
    p.data_creation = DotMap(
                                ...
                                # Data directory
                                data_dir='/local-scratch/anjianl/project/WayPtNav/data_tmp/sine_function_trainer_data'
    )
