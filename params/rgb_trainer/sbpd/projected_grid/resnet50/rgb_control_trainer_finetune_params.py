...
def create_params():
    ...
    p.trainer.ckpt_path = '/local-scratch/tara/project/WayPtNav-reachability/Database/LB_WayPtNav_Data/pretrained_weights/E2E/session_2019-01-27_23-34-22/checkpoints/ckpt-18'
    ...
    #    '/home/anjianl/Desktop/project/WayPtNav/data/successful_data/v2_no_filter_obstacle/area5a/success_v2_45k']
        '/local-scratch/tara/project/WayPtNav-reachability/Database/LB_WayPtNav_Data/sbpd_projected_grid_include_last_step_successful_goals_only / area3 / full_episode_random_v1_100k',
