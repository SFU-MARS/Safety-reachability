...
def create_params():
    ...
    p.trainer.num_samples = int(60*489)
    ...
    p.data_creation.data_dir = ['/local-scratch/tara/project/WayPtNav-reachability/Database/LB_WayPtNav_Data/Generated-Data/area3/0914-new-all60']
