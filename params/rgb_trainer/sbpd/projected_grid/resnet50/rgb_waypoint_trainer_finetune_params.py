...
def create_params():
    ...
    p.model.num_inputs.image_size = [224, 224,180]
    ...
    p.data_creation.data_dir = [
        '/local-scratch/tara/project/WayPtNav-reachability/Database/LB_WayPtNav_Data/Generated-Data/area3/0729-stack3-1']
