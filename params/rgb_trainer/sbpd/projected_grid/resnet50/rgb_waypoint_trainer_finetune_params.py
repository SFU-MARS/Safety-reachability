...
def create_params():
    ...
    p.data_creation.data_dir = [
            '/local-scratch/tara/project/WayPtNav-reachability/Database/LB_WayPtNav_Data/Generated-Data/area3/anjian0-newv6_FRS-M-5image-4d-sample-spline200-2-safe2']    # / localscratch / ttoufigh/ anjian0-newv6_FRS-1/
    ...
    p.data_creation.data_points = 50
