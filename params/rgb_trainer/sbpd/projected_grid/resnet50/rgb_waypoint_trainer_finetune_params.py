...
def create_params():
    ...
    p.trainer.num_samples = int(1000) #int(200)
    ...
    p.data_creation.data_dir = [
            '/local-scratch/tara/project/WayPtNav-reachability/Database/LB_WayPtNav_Data/Generated-Data/area3/anjian0-newv6_FRS-M-5image-4d-sample-spline200-2-safe2-sure-dv-1000']    # / localscratch / ttoufigh/ anjian0-newv6_FRS-1/
