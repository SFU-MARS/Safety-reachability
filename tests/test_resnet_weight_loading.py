...
def resnet50_cnn(image_size=[224, 224, 3], num_inputs=4, num_outputs=3, dtype=tf.float32):
    ...
    model.load_weights('/local-scratch/tara/project/WayPtNav-reachability/Database/LB_WayPtNav_Data/resnet50_weights/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5', by_name=True)
