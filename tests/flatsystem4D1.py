...
#                     [0.113, 0.15, 0], [0.15, -0.1, -0.2], [0.45, -0.05, 0], [0.4,-0.25, -0.5]] #w/ navid
#
...
# actions_waypoint = [[.5, 0, 0], [0.25, -0.5, -1.1],[0.25, 0.5, 1.1],[0.3, 0.4, 0.9],[0.3, -0.4, -0.9],
#                     [0.25,0.8,0.9],[0.25,-0.8,-.9],[0.4, 0.2, 0.3],[0.4, -0.2, -0.3], [0.1, 0.5, 0.5],[0.1, -0.5, -0.5],
#                     [0.4, 0.4, 0.8], [0.4, -0.4, -0.8],  [0.45, 0.2, 0.9],[0.35, -0.3, -1], [0.35, 0.3, 1], [0.45, -0.2, -0.9], [0.45, -0.1, -0.2],[0.45, 0.1, 0.2],
#                     [0.1, 0.1, 0.4],[0.1, -0.1, -0.4],[0.15, -0.1, -0.6], [0.15, 0.1, 0.6],[0.15, 0.35, -0.3],[0.15, -0.35, -0.3], [0.25, -0.25, 0.1],[0.25, 0.25, 0.1] ]
# actions_waypoint = [[.5, 0, 0], [0.2, -0.4, -0.6],[0.25, 0.4, 1],[0.3, 0.25, 0.7],[0.3, -0.25, -0.7],
#
...
# actions_waypoint = [[.5, 0, 0], [0.45, -0.05, -0.1], [0.4, -0.15, -0.7], [0.35, 0.1, 0.4], [0.25, 0.2, 1]]
x = [_/20 for _ in range(10)]
y= [_/22 for _ in range(10 ) ]
theta=[_/9 for _ in range(10)]
for xi in x:
    for yi in y:
        for ti in theta:
            actions_waypoint=[[xi,yi,ti]]
            xf = np.concatenate((actions_waypoint,vf[0]*np.ones((len(actions_waypoint),1))),axis = 1)
            uf = [0, 0]
            Tf = 1
            dt=0.05
