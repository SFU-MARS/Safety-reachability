...
def test_spline_3rd_order(visualize=False):
    ...
    # required_horizon_n1 = spline_traj.compute_dynamically_feasible_horizon(max_speed, max_angular_speed,acceleration_max_system)
    ...
    # spline_traj.rescale_spline_horizon_to_dynamically_feasible_horizon(max_speed, max_angular_speed, acceleration_max_system)
    ...
    valid_idxs_n = spline_traj.find_trajectories_within_a_horizon(horizon_s=2.)
    assert valid_idxs_n.shape == (1,)
    assert valid_idxs_n.numpy()[0] == 0
    spline_traj.speed_nk1()
    spline_traj.position_nk2()
    spline_traj.heading_nk1()
