...
def test_spline_3rd_order(visualize=False):
    ...
    target_state =[.15,0.1,0]
    v0 = np.random.uniform(0., 0.5, 1)  # Initial speed
    vf = 0.
    # vf = 0.6
...
def test_spline_rescaling():
    ...
    dt = .1
    k = 10
    final_times_n1 = tf.constant([[1.], [1.]])

    # Goal states and initial speeds
    goal_posx_n11 = tf.constant([[[0.15]], [[0.3]]])
    goal_posy_n11 = tf.constant([[[0.1]], [[0.15]]])
    goal_heading_n11 = tf.constant([[[0.]], [[0.]]])
