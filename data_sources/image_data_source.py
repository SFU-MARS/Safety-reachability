...
class ImageDataSource(DataSource):
    ...
    def load_dataset(self):
        ...
        metadata = {}
        # os.chdir(str(self.p.data_creation.data_dir[0]))
        # for file in glob.glob("*.pkl"):
        #     data_files=file
        #
        # # data_files = glob.glob(str(self.p.data_creation.data_dir),*.pkl)
        ...
        #         data = pickle.load(f)
        #
        #         img_filename = os.path.join(str(self.p.data_creation.data_dir), file)
        #         metadata[img_filename] = self._get_n(data)
        #
        #     # Get the filename 'file{:d}.pkl' and file_number '{:d}'
        #     # filename, _ = self._extract_file_name_and_number(data_file, data_directory)
    ...
    def _get_current_data(self, filename):
        ...
        """
        # print("to here")
        data = {'filename': [[filename]],'num_samples_n1': [[self.metadata[filename]]]}
        # data = {'filename': [[filename]], 'num_samples_n1':[[120]]}
        # # # TODO: replace the filename in consistence with .pkl in data
        # filename_new = filename.replace("/home/anjianl/Desktop/project/WayPtNav/data/pre-training_data", "/home/ext_drive/somilb/data/training_data/sbpd")
        # data = {'filename': [[filename]],
        #         'num_samples_n1': [[self.metadata[filename_new]]]}
        return data
